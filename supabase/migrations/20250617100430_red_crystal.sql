...
-- Create journal_settings table if it doesn't exist
...
DROP POLICY IF EXISTS "Users can view own journal settings" ON public.journal_settings;
DROP POLICY IF EXISTS "Users can create own journal settings" ON public.journal_settings;
DROP POLICY IF EXISTS "Users can update own journal settings" ON public.journal_settings;
...
DROP TRIGGER IF EXISTS update_journal_settings_updated_at ON public.journal_settings;
