        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            />
                    ...
                    <section id="features" className="relative py-32 px-4">
                      <div className="max-w-7xl mx-auto">
                        ...
                        >
                         <motion.div
                variants={fadeInUp}
                whileHover={{ scale: 1.07, y: -2, boxShadow: "0 0 24px 6px #a78bfa, 0 0 48px 12px #f472b6" }} // makes it pop on hover!
                animate={{
                  boxShadow: [
                    "0 0 16px 4px #a78bfa88, 0 0 32px 8px #f472b688",
                    "0 0 32px 8px #a78bfa, 0 0 64px 16px #f472b6",
                    "0 0 16px 4px #a78bfa88, 0 0 32px 8px #f472b688"
                  ],
                  y: [0, -4, 0],
                }}
              ...
              >
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 backdrop-blur-xl mb-6 shadow-[0_0_24px_8px_rgba(168,139,250,0.4)] animate-pulse">
