  ...
  >
    ...
    {highlighted && (
      <motion.div 
        ...
        transition={{ duration: 2, repeat: Infinity }}
        className="absolute top-1.5 left-1 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-purple-600 to-blue-600 text-white text-xs font-bold rounded-full shadow-lg"
      >
        ⭐ RECOMMENDED
      </motion.div>
    )}
