...
import {
  FileText, Plus, ChevronDown, ChevronRight, Folder,
  Trash2, Camera, Loader2, Upload, ExternalLink, Download, Eye
} from 'lucide-react';
                                  ...
                                  <div className="flex items-start gap-3 flex-1">
                                    ...
                                    <div className="flex-1">
                                      ...
                                      <p className="text-xs text-gray-500 mt-1">
                                        {doc.file_type.toUpperCase()} • Uploaded {format(new Date(doc.created_at), 'MMM d, yyyy')}
                                      </p>
                                    </div>
                                  </div>
                                  <Button
