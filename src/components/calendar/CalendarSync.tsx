...
import { Calendar, Settings, Sync, CheckCircle, AlertCircle, ExternalLink, Download, Upload, Globe, Smartphone, Monitor, RefreshCw, Plus, X, Clock, MapPin, Users } from 'lucide-react';
