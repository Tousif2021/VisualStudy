        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Button
              ...
              className="bg-gray-200 hover:bg-sky-100 border border-blue-400 text-gray-800 font-semibold rounded-lg px-4 py-2 transition-colors flex items-center gap-2"
            >
              Generate Flashcards
            </Button>
          </div>
