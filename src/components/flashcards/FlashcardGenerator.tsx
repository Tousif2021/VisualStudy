                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="relative w-full h-[300px] group">
                      {/* Front of Card */}
                      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-6 border-2 border-blue-200 shadow-lg flex flex-col">
                      ...
                      {/* Back of Card (Answer) */}
                      <div className="absolute inset-0 bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-6 border-2 border-purple-200 shadow-lg flex flex-col opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <div className="flex items-center gap-2 mb-4">
